...
import { Loader2, Gift, Heart, Star, Save, ArrowLeft } from "lucide-react";
...
export default function QuickRecommendation({ onBack, onProfileSaved }: QuickRecommendationProps) {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Failed to save profile and recommendations. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsSaving(false);
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 sm:p-6">
      ...
      <div className="text-center space-y-2 mb-6 sm:mb-8">
        ...
        <p className="text-sm sm:text-base text-muted-foreground px-2 sm:px-0">
          Get personalized gift recommendations and save them to your account!
        </p>
      </div>
